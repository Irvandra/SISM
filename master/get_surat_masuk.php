	...
	<div class="container mt-3">
		<div class="container mb-2">
			<div class="row justify-content-center">
				<div class="col-3">
			      <label><h5>Daftar Surat Masuk</h5></label>
			    </div>
			</div>
			<div class="row justify-content-end">
			    <div class="col-1">
			      <a class="btn btn-success" href="add_surat_masuk.php" role="button">Tambah</a>
			    </div>
			</div>
		</div>
		<table class="table">
		  ...
		  <tbody>
		  	<?php while($data = mysqli_fetch_array($result)) { ?>
			    <tr>
			      ...
			      <td><a href="../files/<?= $data['fileSuratMasuk'] ?>"><?= $data['fileSuratMasuk'] ?></a></td>
			      <td><a href="update_surat_masuk.php?id=<?= $data['idSuratMasuk']; ?>"><img src="../icon/ic_update.png"></a> <a href="delete_surat_masuk.php?id=<?= $data['idSuratMasuk']; ?>"><img src="../icon/ic_delete.png"></a></td>
			    </tr>
			<?php } ?>
		  </tbody>
		</table>
