...
<body>
	...
	$query = "SELECT * FROM surat_keluar WHERE idSuratKeluar='$id'";
	...
	<div class="container mt-3">
		<div class="container mb-3">
			<div class="row justify-content-center">
				<div class="col-3">
			      <label><h5>Update Surat Keluar</h5></label>
			    </div>
			</div>
		</div>
		<form action="" method="POST" enctype="multipart/form-data">
			<div class="mb-3">
				<input type="text" class="form-control" name="idSuratKeluar" id="idSuratKeluar" value="<?= $data['idSuratKeluar'] ?>" disabled>
			</div>
			<div class="mb-3">
				<input type="text" class="form-control" name="perihal" id="perihal" value="<?= $data['perihalSuratKeluar'] ?>">
			</div>
			<div class="mb-3">
				<input type="text" class="form-control" name="tujuan" id="tujuan" value="<?= $data['tujuanSuratKeluar'] ?>">
			</div>
			<div class="mb-3">
				<input type="date" class="form-control" name="tanggal" id="tanggal" value="<?= $data['tanggalSuratKeluar'] ?>">
			</div>
			<div class="mb-3">
	...
	if (isset($_POST['submit'])) {
		...
		$query = "UPDATE surat_keluar SET tujuanSuratKeluar = '$tujuan', tanggalSuratKeluar = '$tanggal', perihalSuratKeluar = '$perihal', fileSuratKeluar = '$filename' WHERE idSuratKeluar = '$id'";
		$result = mysqli_query($conn, $query);
