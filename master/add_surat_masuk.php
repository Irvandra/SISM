...
<body>
	...
	<div class="container mt-3">
		<div class="container mb-3">
			<div class="row justify-content-center">
				<div class="col-3">
			      <label><h5>Tambah Surat Masuk</h5></label>
			    </div>
			</div>
		</div>
		<form action="" method="POST" enctype="multipart/form-data">
			...
			<div class="mb-3">
				<input required type="text" class="form-control" name="asal" id="asal" placeholder="Pengirim">
			</div>
			<div class="mb-3">
	...
	if (isset($_POST['submit'])) {
		...
		$query = "INSERT INTO surat_masuk (idSuratMasuk, perihalSuratMasuk, asalSuratMasuk, tanggalSuratMasuk, fileSuratMasuk) VALUES ('$id', '$perihal','$asal', '$tanggal', '$filename')";
